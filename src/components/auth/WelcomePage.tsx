  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-[var(--bg-primary)] text-[#ffffff] overflow-x-hidden selection:bg-[var(--accent)] selection:text-white">
      ...
      <main className="flex-1 flex flex-col items-center pt-[56px] z-10 w-full max-w-[1280px] mx-auto pb-24">
        ...
        {/* Hero Section */}
        <section className="relative w-full flex flex-col items-center justify-center pt-24 md:pt-32 pb-16 md:pb-24 px-6 text-center min-h-[500px] md:h-[700px] border-b border-[var(--border)]/50 overflow-hidden">
          ...
          >
            ...
            <motion.p 
              ...
              className="max-w-[550px] font-mono text-[#adaaad] text-xs md:text-sm leading-relaxed mb-10 px-4"
            >
        ...
        <section className="w-full max-w-[900px] px-6 mt-12 md:mt-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-auto">
             
            {/* Benefit 1: Large Feature (Organize - LEFT STACKED) */}
            <div className="lg:col-span-8 bg-[#1f1f22] border-l-2 border-[#f3ffca] p-6 md:p-8 flex flex-col justify-end relative overflow-hidden group min-h-[250px] md:min-h-[300px]">
               <div className="z-10 mt-auto">
                 ...
                 <h3 className="text-[#fffbfe] font-main font-bold text-xl md:text-2xl mb-3">Organize snippets with ease</h3>
                 <p className="text-[#adaaad] font-mono text-[10px] md:text-xs leading-relaxed max-w-[340px]">
                   Multi-dimensional categorization using our proprietary tagging engine. Never lose a logic block again.
                 </p>
               </div>
               <div className="absolute right-0 top-0 w-[40%] h-full bg-[#2a2a2d] hidden sm:block" />
            </div>

            {/* Benefit 2: Search (Top Right) */}
            <div className="lg:col-span-4 bg-[#1f1f22] p-6 md:p-8 flex flex-col justify-between min-h-[200px] md:min-h-[300px]">
               <div>
            ...
            <div className="lg:col-span-4 bg-[#1f1f22] p-6 md:p-8 flex flex-col min-h-[200px]">
               <div>
                  <div className="mb-4 text-[var(--accent)]">
            ...
            <div className="lg:col-span-8 bg-[#1f1f22] border-r-2 border-[var(--accent)] p-6 md:p-8 flex flex-col sm:flex-row sm:items-center relative gap-8 group min-h-[200px]">
               <div className="z-10 flex-1">
                 <div className="mb-4 text-[var(--accent)]">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                 </div>
                 <h3 className="text-[#fffbfe] font-main font-bold text-lg md:text-xl mb-3">Versioning & History</h3>
                 <p className="text-[#adaaad] font-mono text-[10px] md:text-xs leading-relaxed max-w-[340px]">
                   Full immutable logs for every snippet. Revert, branch, and merge logic clusters like a professional.
                 </p>
               </div>
               
               <div className="w-[120px] h-[80px] md:h-[100px] border border-black bg-black flex flex-col justify-center items-start gap-2 p-4 hidden sm:flex">
