            ...
            <div className="h-24 md:h-20 border-t border-[var(--border)]/30 bg-[#161616] flex flex-col md:flex-row items-center justify-center md:justify-between px-6 md:px-8 gap-4 py-4 md:py-0 shrink-0">
               ...
               <div className="flex items-center gap-4 md:gap-6 w-full md:w-auto">
                 ...
                 <button 
                  ...
                  className="flex-1 md:flex-none bg-[var(--accent)] text-white text-[11px] font-main font-bold uppercase tracking-[2px] px-6 md:px-10 py-3.5 hover:bg-[#ff0000] transition-all shadow-[6px_6px_0px_#7a0000] md:shadow-[8px_8px_0px_#7a0000]"
                 >
