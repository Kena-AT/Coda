          ...
          <aside className="w-64 border-r border-[var(--border)]/30 bg-[var(--bg-primary)] flex flex-col justify-between">
            <div className="flex flex-col p-4 gap-1">
              ...
              <button 
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 text-[10px] font-main font-bold uppercase tracking-[1px] transition-all border-l-2 ${activeTab === 'PASTE_CODE' ? 'bg-[var(--accent)]/10 border-[var(--accent)] text-white' : 'border-transparent text-[#adaaad] hover:text-white hover:bg-white/5'}`}
              >
                <Code2 size={14} />
                PASTE_CODE
              </button>
              <button 
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 text-[10px] font-main font-bold uppercase tracking-[1px] transition-all border-l-2 ${activeTab === 'UPLOAD_FILES' ? 'bg-[var(--accent)]/10 border-[var(--accent)] text-white' : 'border-transparent text-[#adaaad] hover:text-white hover:bg-white/5'}`}
              >
                <UploadCloud size={14} />
                UPLOAD_FILES
              </button>
                   ...
                   <div className="flex-1 bg-[#151515] border border-[var(--border)] p-4 flex flex-col relative overflow-hidden">
                      ...
                      <div className="flex flex-col gap-1 flex-1 overflow-y-auto max-h-[160px] custom-scrollbar relative z-10">
                         <button 
                           ...
                           className={`w-full text-left p-2 text-[10px] font-mono uppercase tracking-[0.5px] transition-colors flex items-center justify-between ${selectedProjectId === null ? 'bg-[var(--accent)] text-white' : 'text-[#adaaad] hover:bg-white/5'}`}
                         >
                         ...
                         {projects.map(p => (
                           <button 
                             ...
                             className={`w-full text-left p-2 text-[10px] font-mono uppercase tracking-[0.5px] transition-colors flex items-center justify-between ${selectedProjectId === p.id ? 'bg-[var(--accent)] text-white' : 'text-[#adaaad] hover:bg-white/5'}`}
                           >
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#0a0a0a]">
                 ...
                 >
                    ...
                    <div className="text-center">
                       ...
                       <p className="text-[var(--accent)] text-[9px] font-mono uppercase mt-2 opacity-50">Supports multi-file selection & batch ingestion</p>
                    </div>
                 </div>
              </div>
            )}
            ...
            <div className="h-20 border-t border-[var(--border)]/30 bg-[#161616] flex items-center justify-between px-8 shrink-0">
               ...
               <div className="flex items-center gap-6">
                 ...
                 <button 
                  ...
                  className="bg-[var(--accent)] text-white text-[11px] font-main font-bold uppercase tracking-[2px] px-10 py-3.5 hover:bg-[#ff0000] transition-all shadow-[8px_8px_0px_#7a0000]"
                 >
