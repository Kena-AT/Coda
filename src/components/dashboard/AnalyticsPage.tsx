  ...
  return (
    <div className="flex-1 p-10 overflow-y-auto custom-scrollbar bg-[#0a0a0a] selection:bg-[#e60000] selection:text-white">
      ...
      <div className="grid grid-cols-12 gap-6 mb-12">
        ...
        <div className="col-span-8 bg-[#111111] border border-[#222226] p-8 flex flex-col gap-6 relative overflow-hidden">
      ...
      <div className="mb-12">
        ...
        <div className="w-full">
           <div className="grid grid-cols-12 px-6 py-4 text-[9px] font-mono text-[#adaaad] uppercase tracking-[2px] border-b border-[#222226]/50">
              ...
              {summary?.ledger.map((s, idx) => (
                <div key={idx} className="grid grid-cols-12 px-6 py-5 border-b border-[#222226]/30 hover:bg-[#111111] transition-colors group">
                   ...
                   <div className="col-span-2 flex items-center">
                      <span className={`px-2 py-0.5 text-[9px] font-mono uppercase bg-[#1c1b1b] border border-[#222226] text-[#adaaad]`}>
                         {s.language}
                      </span>
                   </div>
      ...
      <div className="grid grid-cols-2 gap-8 mt-12 pb-12">
         <div className="bg-[#111111] border border-[#222226] p-8 flex flex-col gap-6">
         ...
         <div className="bg-[#111111] border border-[#222226] p-8 flex items-center gap-10">
