...
![Version](https://img.shields.io/badge/version-1.0.0--PRODUCTION-red?style=for-the-badge)
...
| :--------------------------- | :----------------------------------------------------------------- | :------------------------------------------------------------ |
| **Standard Installer** | [Coda_1.0.0_x64-setup.exe](./release_output/Coda_1.0.0_x64-setup.exe) | Recommended for most users. Includes auto-update support.     |
| **Enterprise MSI**     | [Coda_1.0.0_x64_en-US.msi](./release_output/Coda_1.0.0_x64_en-US.msi) | Designed for silent installations and system-wide deployment. |
