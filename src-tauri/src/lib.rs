...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            snippet::permanently_delete_snippet,
            snippet::toggle_favorite,
            snippet::create_tag,
            snippet::list_tags,
            snippet::update_tag,
            snippet::delete_tag,
            snippet::add_tag_to_snippet,
            snippet::remove_tag_from_snippet,
            ...
            snippet::purge_snippet_cache_all,
            snippet::get_snippet_content,
            snippet::sync_all_metadata,
